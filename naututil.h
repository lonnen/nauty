/*****************************************************************************
* This is the header file for versions 2.0 of naututil.c and dreadnaut.c.    *
*                                                                            *
...
EXTPROC(UPROC cellcliq,(graph*,nvector*,nvector*,int,int,int,permutation*,
                      int,boolean,int,int))
EXTPROC(UPROC cellfano,(graph*,nvector*,nvector*,int,int,int,permutation*,
                      int,boolean,int,int))
EXTPROC(UPROC cellfano2,(graph*,nvector*,nvector*,int,int,int,permutation*,
                      int,boolean,int,int))
...
EXTPROC(void getbigcells,(nvector*,int,int,int*,shortish*,shortish*,int))
...
EXTPROC(void nautinv_check,(int,int,int,int))
EXTPROC(void naututil_check,(int,int,int,int))
EXTPROC(void nautinv_null,(void))
...
EXTPROC(UPROC quadruples,(graph*,nvector*,nvector*,int,int,int,permutation*,
                      int,boolean,int,int))
EXTPROC(long ran_arr_cycle,(void))
EXTPROC(void ran_array,(long*, int))
EXTPROC(void ran_init,(long))
...
EXTPROC(void readvperm,(FILE*,permutation*,boolean,int,int*))
EXTPROC(boolean readstring,(FILE*,char*,int))
EXTPROC(void relabel,(graph*,nvector*,permutation*,graph*,int,int))
EXTPROC(long sethash,(set*,int,long,int))
EXTPROC(int setinter,(set*,set*,int))
EXTPROC(void setnbhd,(graph*,int,int,set*,set*))
EXTPROC(int setsize,(set*,int))
EXTPROC(void sublabel,(graph*,permutation*,int,graph*,int,int))
...
#if (SYS_BSDUNIX | SYS_VAXBSD | SYS_APOLLO | SYS_ALPHA | SYS_ALPHA32)
#include <sys/time.h>
...
/* Not used from verson 2.0 onwards. */
...
The statistical quality is unimportant.

From version 2.0, the routines in naututil.c use Don Knuth's 
random number generator rng.c; accessed here using KRAN. */
...
WORKSIZE automorphisms.  To ensure this, it provides 2 * WORKSIZE * m
