/*****************************************************************************
*                                                                            *
* This is the main file for dreadnaut() version 2.0, which is a test-bed     *
*   for nauty() version 2.0.                                                 *
*                                                                            *
...
DYNALLSTAT(nvector,lab,lab_sz);
DYNALLSTAT(nvector,ptn,ptn_sz);
DYNALLSTAT(nvector,orbits,orbits_sz);
DYNALLSTAT(nvector,savedlab,savedlab_sz);
...
static nvector ptn[MAXN];
static nvector orbits[MAXN];
static nvector savedlab[MAXN];
...
main()
{
	...
	n = WORDSIZE;
        ...
        DYNALLOC1(nvector,lab,lab_sz,n,"dreadnaut");
        DYNALLOC1(nvector,ptn,ptn_sz,n,"dreadnaut");
        DYNALLOC1(setword,workspace,workspace_sz,
                                            worksize,"dreadnaut");
        DYNALLOC1(nvector,orbits,orbits_sz,n,"dreadnaut");
	...
	options.tc_level = INFINITY;
     ...
     /* Calling dummy routines in nautinv.c, nauty.c and nautil.c causes
        ...
        while (curfile >= 0)
		    ...
		    DYNALLOC1(nvector,savedlab,savedlab_sz,n,"dreadnaut");
#endif
                    sgn = n;
		    ...
		    DYNALLOC2(graph,canong,canong_sz,n,m,"dreadnaut");
                    ...
                    DYNALLOC1(nvector,lab,lab_sz,newn,"dreadnaut");
                    DYNALLOC1(nvector,ptn,ptn_sz,newn,"dreadnaut");
		    worksize = 2*WORKSIZE*newm;
                    DYNALLOC1(setword,workspace,workspace_sz,
                                                        worksize,"dreadnaut");
                    DYNALLOC1(nvector,orbits,orbits_sz,newn,"dreadnaut");
...
H("   I : refine using invar  _ : complement         6 = cellquads")
H("   j : relabel randomly    % : Mathon doubling    7 = cellquins")
H("k=# # : set invar levels   & : type colouring     8 = distances")
